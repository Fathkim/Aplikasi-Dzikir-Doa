...
import com.fathan.doadandzikir.adapter.ArtikelAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupViewPager() {
        val llSlidersDots: LinearLayout = findViewById(R.id.ll_slider_dots)
        ...
        for (i in 0 until listArtikel.size) {
            ...
            llSlidersDots.addView(dotSlider[i], params)
        }
  ...
  private  fun intView() {
      ...
      val vpAtikel: ViewPager2 = findViewById(R.id.vp_artikel)
      vpArtikel.adapter = ArtikelAdapter(listArtikel)
